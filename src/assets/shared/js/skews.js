...
const createRerenderSvgDomElements = () => {
    try {
        ...
        if (pro != null) {
            ...
            wh = [body.getBoundingClientRect().width, lastPro.getBoundingClientRect().height];
            const svgBtmLeft = `<path d="M0 ${wh[1] - (ch / 2)} L0 ${wh[1] + 2} L${wh[0]} ${wh[1] + 2} L${wh[0]} ${wh[1]}" fill="white"></path>`;
